...
.. list-table::
   ...
   * - Embedding maps
     - Embedding structure, trajectories, or value overlays need inspection
   * - Statistics
...
map workflows are centered on structure discovery, trajectories, and scalar
overlays in learned representations. Statistical workflows are centered on
hypothesis testing, regression, and uncertainty quantification.
